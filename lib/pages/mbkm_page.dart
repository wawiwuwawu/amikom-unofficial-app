                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: OutlinedButton.icon(
                                  onPressed: item.fileLolos.isNotEmpty
                                      ? null
                                      : () => _showUploadLuaran(item),
                                  icon: const Icon(
                                    CupertinoIcons.rocket,
                                    size: 16,
                                  ),
                                  label: Text(
                                    item.fileLolos.isNotEmpty
                                        ? 'Selesai'
                                        : 'Luaran',
                                    style: const TextStyle(fontSize: 13),
                                  ),
                                  style: OutlinedButton.styleFrom(
                                    ...
                                    side: BorderSide(
                                      color: item.fileLolos.isNotEmpty
                                          ? Colors.grey.shade300
                                          : const Color(
                                              0xFF501F66,
                                            ).withValues(alpha: 0.5),
        ...
        child: Row(
          children: [
            Icon(
              ...
              color: path == null ? Colors.grey : const Color(0xFF501F66),
            ),
