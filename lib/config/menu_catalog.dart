...
abstract final class MenuCatalog {
  ...
  static final List<MenuEntry> all = [
    ...
    MenuEntry(
      ...
      icon: CupertinoIcons.building_2_fill,
      frequency: MenuFrequency.insidental,
      build: (ctx) => VisiMisiInstitusiPage(),
    ),
    MenuEntry(
